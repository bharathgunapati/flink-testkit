...
/**
 * Sample Flink job: Kafka JSON source → JDBC (Postgres) sink.
 * Consumer-style example under {@code examples/jdbc}, not part of the library.
 */
public final class OrderJdbcSinkJob {
    ...
    public static JobClient runAsync(
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
            ...
            .setGroupId("examples-order-jdbc-sink")
        ...
        return env.executeAsync("examples-order-jdbc-sink");
    }
}
