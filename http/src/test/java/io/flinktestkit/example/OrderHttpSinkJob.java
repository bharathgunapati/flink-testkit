...
/**
 * Example Flink job using Apache {@code flink-connector-http} HttpSink.
 * Fixture for {@link OrderHttpSinkJobTest}, not part of the library.
 */
public final class OrderHttpSinkJob {
    ...
    public static JobClient runAsyncJson(String endpointUrl, String... jsonBodies) throws Exception {
        ...
        stream.sinkTo(sink);
        return env.executeAsync("order-http-sink-job");
    }
}
